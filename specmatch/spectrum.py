...
class CalcIR(object):
    ...
    def __init__(self, status, rate, orig_ir):
        self.status = status
        self.rate = rate
        self.orig_ir = orig_ir
        self._source_sound = None
        self._destination_sound_file = None
    ...
    @property
    def destination_sound_file(self):
        return self._destination_sound_file
    @destination_sound_file.setter
    ...
    @property
    def source_sound(self):
        return self._source_sound
    @source_sound.setter
    def source_sound(self, v):
        self._source_sound = v
        self.a2 = None

    @property
    def a2(self):
        if self._a2 is None:
            self.a2 = self.source_sound
            self.status.clear()
        return self._a2
    @a2.setter
    def a2(self, v):
